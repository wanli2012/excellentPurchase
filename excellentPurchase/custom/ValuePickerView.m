...
- (void)initSubViews
{
    ...
    self.statePicker.backgroundColor = LBHexadecimalColor(0xE8E8E8);
    ...
    self.controllerToolBar.backgroundColor = LBHexadecimalColor(0xE8E8E8);
    ...
    [self.finishBtn setTitleColor:LBHexadecimalColor(0x333333) forState:UIControlStateNormal];
