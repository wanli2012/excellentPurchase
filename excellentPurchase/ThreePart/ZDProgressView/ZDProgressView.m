...
- (void)zdFrame:(CGRect)frame
{
    ...
    self.oneView.frame = CGRectMake(0, 0, 0, frame.size.height);
    self.oneView.layer.cornerRadius = frame.size.height/2;
    self.oneLabel.frame = CGRectMake(40, 0, frame.size.width - 40, frame.size.height);
    self.twoView.frame = CGRectMake(0, 0, frame.size.width, frame.size.height);
    self.twoView.layer.cornerRadius = frame.size.height/2;
    self.twoLabel.frame = CGRectMake(40, 0, frame.size.width - 40, frame.size.height);
