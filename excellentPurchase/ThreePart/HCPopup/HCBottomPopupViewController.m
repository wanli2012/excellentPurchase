...
- (void)setTitle:(NSString *)title{
    ...
    if ([_title isEqualToString:@"确定解除绑定"]) {
        [self setTitleColor:YYSRGBColor(254, 102, 102, 1) forState:UIControlStateNormal];
    }else{
         [self setTitleColor:YYSRGBColor(107, 107, 107, 1) forState:UIControlStateNormal];
    }
...
- (void)setupSubViewWithPopupView:(UIView *)popupView withController:(UIViewController *)controller{
    popupView.backgroundColor = [UIColor groupTableViewBackgroundColor];
    popupView.alpha = 0.4;
