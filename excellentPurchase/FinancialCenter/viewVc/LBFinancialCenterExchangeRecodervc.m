...
@interface LBFinancialCenterExchangeRecodervc()<UITableViewDataSource,UITableViewDelegate>
...
-(void)postRequest:(BOOL)isRefresh{
    ...
    [NetworkManager requestPOSTWithURLStr:kget_mark_list paramDic:dic finish:^(id responseObject) {
