...
-(UIView*)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    UILabel*label=[[UILabel alloc]initWithFrame:CGRectMake(screenWith*component/4, 0,screenWith/4, rowHeight)];
    ...
    switch (component) {
        case 0:
        {
            ...
            label.frame=CGRectMake(screenWith/4, 0,screenWith/4, rowHeight);
        ...
        case 1:
        {
            ...
            label.frame=CGRectMake(screenWith/3, 0, screenWith/4, rowHeight);
