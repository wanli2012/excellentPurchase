...
static NSString *sendRedPackCell = @"LBSendRedPackCell";
...
- (void)viewDidLoad {
    ...
    //注册cell
    [self.tableView registerNib:[UINib nibWithNibName:sendRedPackCell bundle:nil] forCellReuseIdentifier:sendRedPackCell];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    LBSendRedPackCell *cell = [tableView dequeueReusableCellWithIdentifier:sendRedPackCell forIndexPath:indexPath];
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    cell.modelSend = self.dataArr[indexPath.row];
    return cell;
}
