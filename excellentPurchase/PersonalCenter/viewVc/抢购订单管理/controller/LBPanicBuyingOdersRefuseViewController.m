//
//  LBPanicBuyingOdersRefuseViewController.m
//  excellentPurchase
//
//  Created by 四川三君科技有限公司 on 2018/4/25.
...
@interface LBPanicBuyingOdersRefuseViewController ()<UITableViewDelegate,UITableViewDataSource,LBPanicBuyingOdersdelegete>
...
@implementation LBPanicBuyingOdersRefuseViewController
...
-(void)countDownorder{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:OrderTimeCellNotificationfour object:nil];
}
...
-(void)loadData:(NSInteger)page refreshDirect:(BOOL)isDirect{
    ...
    dic[@"status"] = @"7";//0全部 5已完成 1待付款 10取消
...
-(void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell1.isDisplayfour = YES;
    LBPanicBuyingOdersModel *model = self.dataArr[indexPath.section];
    [cell1 setSecondfour:model.goods_data.active.time row:indexPath.section buyingsecond:nil];
}

-(void)tableView:(UITableView *)tableView didEndDisplayingCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    LBPanicBuyingOdersTableViewCell  *cell1 =  (LBPanicBuyingOdersTableViewCell*)cell;
    cell1.isDisplayfour = NO;
}
