//
//  LBPanicBuyingOdersAllViewController.m
//  excellentPurchase
//
...
@interface LBPanicBuyingOdersAllViewController ()<UITableViewDelegate,UITableViewDataSource,LBPanicBuyingOdersdelegete>
...
@implementation LBPanicBuyingOdersAllViewController
...
-(void)countDownorder{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:OrderTimeCellNotification object:nil];
}
...
-(void)loadData:(NSInteger)page refreshDirect:(BOOL)isDirect{
    ...
    dic[@"status"] = @"0";//0全部 5已完成 1待付款 10取消
...
-(void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell1.isDisplay = YES;
    LBPanicBuyingOdersModel *model = self.dataArr[indexPath.section];
    [cell1 setSecond:model.goods_data.active.time row:indexPath.section buyingsecond:nil];
}
