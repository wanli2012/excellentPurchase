//
//  LBPanicBuyingOdersViewController.m
//  excellentPurchase
//
...
#import "LBPanicBuyingOdersAllViewController.h"
#import "LBPanicBuyingOdersCompleteViewController.h"
#import "LBPanicBuyingOdersObligationViewController.h"
#import "LBPanicBuyingOdersCancelViewController.h"
#import "LBPanicBuyingOdersRefuseViewController.h"
#import "SPPageMenu.h"
#import "CountDown.h"

#define pageMenuH 50   //菜单高度

@interface LBPanicBuyingOdersViewController ()<SPPageMenuDelegate,UIScrollViewDelegate>
...
@implementation LBPanicBuyingOdersViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"限时抢购订单";
    [self addMenu];//加载菜单
    
    [self.countDown countDownWithPER_SECBlock:^{
        
        [[NSNotificationCenter defaultCenter]postNotificationName:@"countDownorder" object:nil];
    }];
}
-(void)addMenu{
...
-(NSMutableArray*)controllerClassNames{
    ...
    if (!_controllerClassNames) {
        _controllerClassNames = [NSMutableArray arrayWithObjects:@"LBPanicBuyingOdersAllViewController",@"LBPanicBuyingOdersCompleteViewController",@"LBPanicBuyingOdersObligationViewController",@"LBPanicBuyingOdersCancelViewController",@"LBPanicBuyingOdersRefuseViewController", nil];
    }
