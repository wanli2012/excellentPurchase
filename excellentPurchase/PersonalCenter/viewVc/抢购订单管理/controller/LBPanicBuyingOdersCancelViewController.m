//
//  LBPanicBuyingOdersCancelViewController.m
//  excellentPurchase
//
...
@interface LBPanicBuyingOdersCancelViewController ()<UITableViewDelegate,UITableViewDataSource,LBPanicBuyingOdersdelegete>
...
@implementation LBPanicBuyingOdersCancelViewController
...
-(void)countDownorder{
    ...
    for (int i = 0; i < self.dataArr.count; i++) {
        ...
        second = second - 1;
        model.goods_data.active.time = [NSString stringWithFormat:@"%zd",second];
    }
    [[NSNotificationCenter defaultCenter]postNotificationName:OrderTimeCellNotificationthree object:nil];
}
...
-(void)loadData:(NSInteger)page refreshDirect:(BOOL)isDirect{
    ...
    dic[@"status"] = @"10";//0全部 5已完成 1待付款 10取消
...
-(void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell1.isDisplaythree = YES;
    LBPanicBuyingOdersModel *model = self.dataArr[indexPath.section];
    [cell1 setSecondthree:model.goods_data.active.time row:indexPath.section buyingsecond:nil];
}

-(void)tableView:(UITableView *)tableView didEndDisplayingCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    LBPanicBuyingOdersTableViewCell  *cell1 =  (LBPanicBuyingOdersTableViewCell*)cell;
    cell1.isDisplaythree = NO;
}
