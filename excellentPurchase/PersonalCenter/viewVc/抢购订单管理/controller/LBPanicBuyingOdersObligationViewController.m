//
//  LBPanicBuyingOdersObligationViewController.m
//  excellentPurchase
//
...
@interface LBPanicBuyingOdersObligationViewController ()<UITableViewDelegate,UITableViewDataSource,LBPanicBuyingOdersdelegete>
...
@implementation LBPanicBuyingOdersObligationViewController
...
-(void)countDownorder{
    ...
    for (int i = 0; i < self.dataArr.count; i++) {
        ...
        second = second - 1;
        model.goods_data.active.time = [NSString stringWithFormat:@"%ld",second];
    }
    [[NSNotificationCenter defaultCenter]postNotificationName:OrderTimeCellNotificationone object:nil];
}
...
-(void)loadData:(NSInteger)page refreshDirect:(BOOL)isDirect{
    ...
    dic[@"status"] = @"1";//0全部 5已完成 1待付款 10取消
...
-(void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell1.isDisplayone = YES;
    LBPanicBuyingOdersModel *model = self.dataArr[indexPath.section];
    [cell1 setSecondone:model.goods_data.active.time row:indexPath.section buyingsecond:nil];
}

-(void)tableView:(UITableView *)tableView didEndDisplayingCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    LBPanicBuyingOdersTableViewCell  *cell1 =  (LBPanicBuyingOdersTableViewCell*)cell;
    cell1.isDisplayone = NO;
}
