//
//  LBDolphinRecoderAllViewController.m
//  excellentPurchase
//
...
#import "LBDolphinRecoderAllViewController.h"
...
@interface LBDolphinRecoderAllViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation LBDolphinRecoderAllViewController

- (void)viewDidLoad {
    [super viewDidLoad];
 
    [self.tableview registerNib:[UINib nibWithNibName:@"LBDolphinRecoderWaitCell" bundle:nil] forCellReuseIdentifier:@"LBDolphinRecoderWaitCell"];
    [self.tableview registerNib:[UINib nibWithNibName:@"LBDolphinRecoderAlreadyCell" bundle:nil] forCellReuseIdentifier:@"LBDolphinRecoderAlreadyCell"];
...
-(UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([model.indiana_status integerValue] == 1) {
        ...
        LBDolphinRecoderWaitCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LBDolphinRecoderWaitCell" forIndexPath:indexPath];
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        cell.model = model;
        WeakSelf;
        cell.jumpMynumbers = ^(LBDolphinRecodermodel *model) {
            weakSelf.hidesBottomBarWhenPushed = YES;
        ...
        LBDolphinRecoderAlreadyCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LBDolphinRecoderAlreadyCell" forIndexPath:indexPath];
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        cell.model = model;
        WeakSelf;
        cell.jumpMynumbers = ^(LBDolphinRecodermodel *model) {
