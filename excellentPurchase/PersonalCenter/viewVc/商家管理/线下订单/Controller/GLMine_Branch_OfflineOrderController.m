//
//  GLMine_Branch_OfflineOrderController.m
//  excellentPurchase
//
...
#import "GLMine_Branch_OfflineOrderController.h"
#import "SPPageMenu.h"

#import "GLMine_Branch_OfflineStatusController.h"//线下订单列表

#define pageMenuH 50   //菜单高度
@interface GLMine_Branch_OfflineOrderController ()<SPPageMenuDelegate,UIScrollViewDelegate>
...
@implementation GLMine_Branch_OfflineOrderController
...
-(NSArray*)menuArr{
    ...
    if (!_menuArr) {
        _menuArr = [NSArray arrayWithObjects:@"审核中",@"已完成",@"已失败",nil];
    }
...
-(NSMutableArray*)controllerClassNames{
    ...
    if (!_controllerClassNames) {
        _controllerClassNames = [NSMutableArray arrayWithObjects:
                                 @"GLMine_Branch_OfflineStatusController",
                                 @"GLMine_Branch_OfflineStatusController",
                                 @"GLMine_Branch_OfflineStatusController",
                                 nil];
    }
