//
//  GLMine_Branch_OnLine_AlreadyOrderedController.m
//  excellentPurchase
//
...
#import "GLMine_Branch_OnLine_AlreadyOrderedController.h"
...
@interface GLMine_Branch_OnLine_AlreadyOrderedController ()<UITableViewDelegate,UITableViewDataSource,GLMine_Branch_OnlineFooterDelegate,GLMine_Branch_OnlineHeaderDelegate>
...
@implementation GLMine_Branch_OnLine_AlreadyOrderedController
...
- (void)toOrderDetail:(NSInteger)section{
    ...
    vc.type = 1;//查询状态 2.待发货 3.已发货 11.已取消
    vc.model = self.models[section];
    [self.navigationController pushViewController:vc animated:YES];
}

#pragma mark - GLMine_Branch_OnlineFooterDelegate 取消订单 确认订单
