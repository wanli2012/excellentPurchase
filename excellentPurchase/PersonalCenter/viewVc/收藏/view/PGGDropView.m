...
//        btn.titleEdgeInsets     = UIEdgeInsetsMake(0, 10, 0, 0);
        ...
        [btn setTitleColor:LBHexadecimalColor(0x333333) forState:UIControlStateNormal];
...
- (void)beginAnimation
{
    [self.array enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        btn.frame               = CGRectMake(self.bgFrame.size.width, idx * 55, self.bgFrame.size.width - 20, 55);
        line.frame              = CGRectMake(self.bgFrame.size.width, idx * 55 + 55, self.bgFrame.size.width - 20, 0.3);
        [UIView animateWithDuration:0.3 + 0.05 * idx
             ...
             usingSpringWithDamping:0.9
              initialSpringVelocity:1
                         ...
                         animations:^{
                             btn.frame      = CGRectMake(10, idx * 55, self.bgFrame.size.width -20, 55 - 0.3);
                             line.frame     = CGRectMake(10, idx * 55 + 55, self.bgFrame.size.width - 20, 0.3);
                         }
        ...
        [UIView animateWithDuration:0.3 - 0.02 * idx
             ...
             usingSpringWithDamping:0.9
              initialSpringVelocity:1
                            options:UIViewAnimationOptionCurveEaseIn
                         animations:^{
                             btn.frame      = CGRectMake(self.bgFrame.size.width, idx * 55, 130, 55 - 0.3);
                             line.frame     = CGRectMake(self.bgFrame.size.width, idx * 55 + 39.7, 130, 0.3);
                         }
                         completion:^(BOOL finished) {
                             [self.delegate dismissMaskview];
                         }];
    }];
