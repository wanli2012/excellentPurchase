//
//  LBTimeLimitAfterTomrroeHeaderView.h
//  excellentPurchase
//
...
#define TimeCellNotificationtwo @"NotificationTimeCelltwo"

@interface LBTimeLimitAfterTomrroeHeaderView : UITableViewHeaderFooterView
