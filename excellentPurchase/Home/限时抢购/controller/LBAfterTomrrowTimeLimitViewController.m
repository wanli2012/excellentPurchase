//
//  LBAfterTomrrowTimeLimitViewController.m
//  excellentPurchase
//
//  Created by 四川三君科技有限公司 on 2018/4/12.
//  Copyright © 2018年 四川三君科技有限公司. All rights reserved.
//

#import "LBAfterTomrrowTimeLimitViewController.h"
#import "LBTimeLimitHorseTableViewCell.h"
#import "LBTimeLimitAfterTomrroeHeaderView.h"
...
@interface LBAfterTomrrowTimeLimitViewController ()<UITableViewDelegate,UITableViewDataSource,TXScrollLabelViewDelegate>
...
@implementation LBAfterTomrrowTimeLimitViewController
...
-(void)countDown{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:TimeCellNotificationtwo object:nil userInfo:@{@"index":@"3"}];
}
//请求数据
...
-(UIView*)tableView:(UITableView*)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (self.raceArr.count <= 0) {
        if (self.model.buying.data.count > 0) {
            if (section == 0) {
                LBTimeLimitAfterTomrroeHeaderView *headerview = [tableView dequeueReusableHeaderFooterViewWithIdentifier:@"LBTimeLimitHeaderView"];
                if (!headerview) {
                    headerview = [[LBTimeLimitAfterTomrroeHeaderView alloc] initWithReuseIdentifier:@"LBTimeLimitHeaderView"];
                }
...
-(void)tableView:(UITableView *)tableView willDisplayHeaderView:(UIView *)view forSection:(NSInteger)section{
    if (self.raceArr.count <= 0) {
        if (self.model.buying.data.count > 0) {
            if (section == 0) {
                LBTimeLimitAfterTomrroeHeaderView  *headerview =  (LBTimeLimitAfterTomrroeHeaderView*)view;
