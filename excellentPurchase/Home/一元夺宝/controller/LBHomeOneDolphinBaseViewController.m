//
//  LBHomeOneDolphinBaseViewController.m
//  excellentPurchase
//
...
NSNotificationName const ChildScrollViewDidScrollNSNotificationDolphin = @"ChildScrollViewDidScrollNSNotificationDolphin";
NSNotificationName const ChildScrollViewRefreshStateNSNotificationDolphin = @"ChildScrollViewRefreshStateNSNotificationDolphin";

@interface LBHomeOneDolphinBaseViewController ()


@end

@implementation LBHomeOneDolphinBaseViewController
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    // 滚动时发出通知
    [[NSNotificationCenter defaultCenter] postNotificationName:ChildScrollViewDidScrollNSNotificationDolphin object:nil userInfo:@{@"scrollingScrollView":scrollView,@"offsetDifference":@(offsetDifference)}];
