//
//  LBHomeOneDolphinWaitViewController.m
//  excellentPurchase
//
...
@interface LBHomeOneDolphinWaitViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation LBHomeOneDolphinWaitViewController
...
-(void)countDownoneDolphin{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:OneDolphinCellNotificationone object:nil];
}
//刷新
...
-(void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    LBHomeViewActivityListModel *model  = _models[indexPath.row];
        ...
        [cell1 setSecondone:model.active_reward_time row:indexPath.row buyingsecond:nil];
}
